...
abstract class Ref<T extends hasChild_Ref<T>> extends TreeNode<T> {
  ...
  protected ArrayList<Pair<Ref, ArrayList<Scope<? extends hasChild_Scope<?>>>>> binds = null;
  protected Boolean binds_computed = false;

  public ArrayList<Pair<Ref, ArrayList<Scope<? extends hasChild_Scope<?>>>>> binds() {
    return null;
  }
...
class mkVarRef<T extends hasChild_Ref<T>> extends Ref<T> {
  ...
  public mkVarRef(String s) {
    this.s = s;
    if (scopeTrace)
      System.out.println("- Created ref " + this.pp());
  }
  ...
  public ArrayList<Pair<Ref, ArrayList<Scope<? extends hasChild_Scope<?>>>>> binds() {
    ...
    if (this.binds_computed)
      return this.binds;

    ArrayList<Pair<Ref, ArrayList<Scope<? extends hasChild_Scope<?>>>>> binds = new ArrayList<Pair<Ref, ArrayList<Scope<? extends hasChild_Scope<?>>>>>();

    binds.add(new Pair<Ref, ArrayList<Scope<? extends hasChild_Scope<?>>>>(this, this.res()));
